...
def niver_casamento(casamento, mes, mes_teste=0):
    if casamento not in ['nan', '', '00/00/0000']:
        if mes_teste == 0:
            ...
            if mes.lower().__contains__(meses.JANEIRO) or\
                    mes.lower().__contains__(meses.FEVEREIRO):
                mes_teste = 2
            elif mes.lower().__contains__(meses.NOVEMBRO) or \
                    mes.lower().__contains__(meses.DEZEMBRO):
                mes_teste = 11
            elif mes.lower().__contains__(meses.MARCO):
                mes_teste = 3
            elif mes.lower().__contains__(meses.ABRIL):
                mes_teste = 4
            elif mes.lower().__contains__(meses.MAIO):
                mes_teste = 5
            elif mes.lower().__contains__(meses.JUNHO):
                mes_teste = 6
            elif mes.lower().__contains__(meses.JULHO):
                mes_teste = 7
            elif mes.lower().__contains__(meses.AGOSTO):
                mes_teste = 8
            elif mes.lower().__contains__(meses.SETEMBRO):
                mes_teste = 9
            elif mes.lower().__contains__(meses.OUTUBRO):
                mes_teste = 10
            else:
